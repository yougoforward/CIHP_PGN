...
LIST_PATH = './datasets/Pascal/list/val.txt'
DATA_ID_LIST = './datasets/Pascal/list/val_id.txt'
with open(DATA_ID_LIST, 'r') as f:
    NUM_STEPS = len(f.readlines())
RESTORE_FROM = './checkpoint/Pascal_pgn'
...
def main():
    ...
    # evaluate prosessing
    parsing_dir = './output/pascal_parsing_maps'
    if not os.path.exists(parsing_dir):
        os.makedirs(parsing_dir)
    edge_dir = './output/pascal_edge_maps'
    ...
    for step in range(NUM_STEPS):
        ...
        parsing_im = Image.fromarray(parsing_[0,:,:,0])
        palette_part = [0, 0, 0,
                        255, 0, 0,
                        0, 255, 0,
                        255, 255, 0,
