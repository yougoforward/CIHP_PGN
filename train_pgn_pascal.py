...
LIST_PATH = './datasets/Pascal/list/train_rev.txt'
DATA_ID_LIST = './datasets/Pascal/list/train_id.txt'
SNAPSHOT_DIR = './checkpoint/Pascal_pgn'
LOG_DIR = './logs/Pascal_pgn'
...
SAVE_PRED_EVERY = int(TRAIN_SET / BATCH_SIZE + 1)   # save model per epoch  (number of training set / batch)
NUM_STEPS = int(SAVE_PRED_EVERY * 100 + 1)  # 100 epoch

restore_from = './checkpoints/deeplab_resnet.ckpt'
